  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed top-3 left-0 right-0 z-50 px-4">
        <motion.div
          className="flex justify-between items-center rounded-full bg-white/80 px-4 py-2 shadow-sm backdrop-blur-md dark:bg-slate-900/80"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="mt-2 rounded-2xl bg-white/80 p-4 shadow-lg backdrop-blur-md dark:bg-slate-900/80"
            >
